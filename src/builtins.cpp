...
const std::vector<BuiltinMethod>& builtin_methods() {
    static const std::vector<BuiltinMethod> table = {
        // strings
        {BT::str, "len", {}, BT::i64, "beans_str_len", false, str_len, "Number of bytes in the string."},
        {BT::str, "is_empty", {}, BT::boolean, "beans_str_is_empty", false, str_is_empty, "True when the string has no bytes."},
        {BT::str, "last", {BT::i64}, BT::str, "beans_str_last", false, str_last, "The last `n` bytes as a new string (clamped to the length)."},
        {BT::str, "first", {BT::i64}, BT::str, "beans_str_first", false, str_first, "The first `n` bytes as a new string (clamped to the length)."},
        {BT::str, "contains", {BT::str}, BT::boolean, "beans_str_contains", false, str_contains, "True when the string contains the given substring."},
        {BT::str, "starts_with", {BT::str}, BT::boolean, "beans_str_starts_with", false, str_starts_with, "True when the string begins with the given prefix."},
        {BT::str, "ends_with", {BT::str}, BT::boolean, "beans_str_ends_with", false, str_ends_with, "True when the string ends with the given suffix."},
        {BT::str, "find", {BT::str}, BT::opt_i64, "beans_str_find", false, str_find, "Byte index of the first match, or none."},
        {BT::str, "rfind", {BT::str}, BT::opt_i64, "beans_str_rfind", false, str_rfind, "Byte index of the last match, or none."},
        ...
        {BT::str, "trim", {}, BT::str, "beans_str_trim", false, str_trim, "The string with leading and trailing whitespace removed."},
        {BT::str, "trim_start", {}, BT::str, "beans_str_trim_start", false, str_trim_start, "The string with leading whitespace removed."},
        {BT::str, "trim_end", {}, BT::str, "beans_str_trim_end", false, str_trim_end, "The string with trailing whitespace removed."},
        {BT::str, "to_upper", {}, BT::str, "beans_str_to_upper", false, str_to_upper, "The string with ASCII letters uppercased."},
