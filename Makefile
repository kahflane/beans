...
SRC := src/token.cpp src/lexer.cpp src/parser.cpp src/ast_print.cpp src/loader.cpp src/mir.cpp src/c_abi.cpp src/checker.cpp src/builtins.cpp src/codegen.cpp src/interp.cpp src/lsppos.cpp src/json.cpp src/lsp.cpp src/lspserver.cpp src/main.cpp
HDR := src/token.h src/lexer.h src/ast.h src/parser.h src/types.h src/target.h src/mir.h src/hir.h src/c_abi.h src/loader.h src/checker.h src/value.h src/builtins.h src/interp.h src/codegen.h src/lsppos.h src/json.h src/lsp.h
BIN := build/beansc
